...
const CONTENT_ITEMS = [
  {
    ...
    body: "Добавлены в бота с отзывами, следующее:
      1. Система отзывов - уже было
      2. Сделано своё меню с информацией ( Раньше была в JB )
      3. вывод в embed чего либо ( не доделано полностью )",
